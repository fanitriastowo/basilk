...
## About
**basilk** is structured to create projects and within each project to create tasks with a specific status (Up Next/On Going/Testing/Pending/Done).
...
- Statuses: **UpNext** (magenta), **OnGoing** (yellow), **Testing** (cyan), **Pending** (blue), **Done** (green, ~~crossed out~~)
